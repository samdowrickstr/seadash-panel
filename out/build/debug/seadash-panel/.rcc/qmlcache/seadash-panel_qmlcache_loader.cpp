...
int QT_MANGLE_NAMESPACE(qInitResources_qmlcache_seadash_panel)() {
    ::unitRegistry();
    return 1;
}
Q_CONSTRUCTOR_FUNCTION(QT_MANGLE_NAMESPACE(qInitResources_qmlcache_seadash_panel))
int QT_MANGLE_NAMESPACE(qCleanupResources_qmlcache_seadash_panel)() {
    return 1;
}
